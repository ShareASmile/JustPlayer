...
import com.brouken.player.NyPlayerActivity;
...
public class MainActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRemoteVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                NyPlayerActivity.start(MainActivity.this, url);
            }
        });
    }
        ...
        try {
            ...
            if (requestCode == VIDEO_REQUEST && data != null) {
              //  String url = NyFileUtil.getPath(this, data.getData());
                NyPlayerActivity.start(MainActivity.this, data.getData());
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        NyPlayerActivity.start(this, path);
    }
}
